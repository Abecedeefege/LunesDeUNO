...
self.addEventListener('push', (event) => {
  ...
  event.waitUntil(self.registration.showNotification(data.title || 'Lunes de UNO', {
    body: data.body || '',
    // icon: la galera de la app bajo un foco (fondo oscuro). badge: silueta
    // blanca sobre transparente — Android solo usa el canal alfa; un PNG
    // opaco renderiza como cuadrado sólido.
